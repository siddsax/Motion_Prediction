...
def getfeatures(nodeName,forecast_on_noisy_features=False):
	...
	if forecast_on_noisy_features:
		forecast_features,temporal_forecast_features = getGCNNfeatures(nodeName,forecast_nodeFeatures_noisy,forecast_nodeFeatures_t_1_noisy)
	else:
		forecast_features,temporal_forecast_features = getGCNNfeatures(nodeName,forecast_nodeFeatures,forecast_nodeFeatures_t_1)

	return train_features,temporal_train_features, validate_features,temporal_validate_features, forecast_features,temporal_forecast_features
