...
def unNormalizeData(normalizedData,data_mean,data_std,dimensions_to_ignore):
	...
	origData[:,dimensions_to_use] = normalizedData[:,dimensions_to_use]
...
def convertAndSave(fname):
	...
	#print(origData)
	if len(origData) > 0:
		fpath = path_to_trajfiles + fname + "_new"
...
all_checkpoints = [
		'checkpoints_dra_T_150_bs_100_tg_100_ls_512_fc_256_initial_lr_0.001_clipnorm_25.0_nschd_[250,500.0,1000.0,1300.0,2000.0,2500.0,3300.0]_nrate_[0.01,0.05,0.1,0.2,0.3,0.5,0.75]_decschd_[1500.0,4500.0]_decrate_[0.1,0.1]_fs_eating_NoEdge'
...
for checkpoint_dir in all_checkpoints:
	...
	if not os.path.exists(path_to_trajfiles):
		#print "WABBBAAAAAAAAAAADSASDASDDDDDDDDDDDDDDDDDDDDDDDDDDDDASSDASDASSSSSSSSPOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOPPPPPPPPPOOOOOOOOOOOOOP"
		continue
	...
	#/new_data/gpu/siddsax/Graph_CNNs/checkpoints_dra_T_150_bs_100_tg_100_ls_512_fc_256_initial_lr_0.001_clipnorm_25.0_nschd_[250,500.0,1000.0,1300.0,2000.0,2500.0,3300.0]_nrate_[0.01,0.05,0.1,0.2,0.3,0.5,0.7]_decschd_[1500.0,4500.0]_decrate_[0.1,0.1]_fc_fs_final/

	#/new_data/gpu/siddsax/Graph_CNNs/checkpoints_dra_T_150_bs_100_tg_100_ls_512_fc_256_initial_lr_0.001_clipnorm_25.0_nschd_\[250\,500.0\,1000.0\,1300.0\,2000.0\,2500.0\,3300.0\]_nrate_\[0.01\,0.05\,0.1\,0.2\,0.3\,0.5\,0.75\]_decschd_\[1500.0\,4500.0\]_decrate_\[0.1\,0.1\]_fs_eating_NoEdge/
